...
import { setSelectedAirCraft, ClassificationType } from '../../store/reducers/aircraftSlice';
import { selectPointTasks } from '../../store/reducers/tasksSlice';
import { TASK_DOT, AircraftType } from '../../types/types';
...
export const WebFallbackMapView = forwardRef<WebFallbackHandle, WebFallbackMapViewProps>(({
  ...
  }).filter(Boolean), [aircrafts, classification]) as any[];
  ...
  const statePayload = useMemo(() => ({
    ...
    targetCoordinates,
  }), [mapRegion, userLocation, tasks, preparedAircrafts, selectedAircraft, targetCoordinates]);
